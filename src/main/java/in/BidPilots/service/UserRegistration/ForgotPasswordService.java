...
public class ForgotPasswordService {
	...
	public Map<String, Object> verifyResetOTP(String email, String otp) {
		...
		try {
			...
			if (!Boolean.TRUE.equals(otpResult.get("success"))) {
				...
				return error(left > 0 ? "Invalid OTP. " + left + " attempt" + (left == 1 ? "" : "s") + " remaining."
			...
			tokenStorage.put(resetToken, email + "|" + LocalDateTime.now().plusMinutes(TOKEN_EXPIRY_MINUTES));
	...
	@Transactional
	public Map<String, Object> resetPassword(String email, String resetToken, String newPassword,
