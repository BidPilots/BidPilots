...
<<<<<<< HEAD
    // ── 2. Bid-matching pool — UserBidMatchingService ─────────────────────────
    //    ADDED @Primary - This will be the default executor for @Async methods
    //    that don't specify a bean name
=======
...
<<<<<<< HEAD
    // ── 3. Bid-close scheduler — BidAutoCloseService ─────────────────────────
=======
